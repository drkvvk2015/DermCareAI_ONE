...
export const clinicApi = {
  ...
  createUpiPayment(payload: { invoice_id: string; customer_name: string; customer_phone: string; customer_email?: string }) {
    return request<{ provider: string; id: string; short_url: string; upi_supported: boolean; amount_paise: number }>('/commerce/payments/razorpay', { method: 'POST', body: JSON.stringify(payload) });
  },
