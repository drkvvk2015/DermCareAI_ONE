...
from dermatology.procedures import (
...
router = APIRouter(
    prefix="/api/v1/dermatology/procedures",
    tags=["dermatology-procedures"],
)
...
def supported_procedures(
    _: dict[str, Any] = Depends(require_roles("doctor", "admin", "auditor")),
):
