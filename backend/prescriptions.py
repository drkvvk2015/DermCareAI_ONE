...
def dispense(
    ...
    # The ledger is the durable idempotency boundary for retries. Once allocation is
    # recorded, a retry never decrements pharmacy stock a second time.
    try:
        ...
        if ledger["status"] == "completed":
            ...
            return {"prescription": result, "dispensing": {
                "prescription_id": prescription_id,
                "patient_id": prescription["patient_id"],
